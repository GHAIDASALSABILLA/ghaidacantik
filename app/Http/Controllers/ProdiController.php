...
class ProdiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validateData = $request->validate(
            ...
            [
                'nama_prodi.required' => 'Nama Prodi nya di isi sayang',
                'nama_prodi.unique' => 'Nama Prodi sudah ada cintaku',
                'nama_prodi.max' => 'Nama Prodi maksimal 255 karakter ya cantikku',
            ]
        );
